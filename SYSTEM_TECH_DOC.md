...
- **Module:** [`src/timegpt_v2/framing/build_payloads.py`](src/timegpt_v2/framing/build_payloads.py:1), [`src/timegpt_v2/forecast/timegpt_client.py`](src/timegpt_v2/forecast/timegpt_client.py:1)
- **Key Changes:** Added exogenous columns (SPY returns, regimes, events) to Y_df/X_df; client passes hist_exog_list.
